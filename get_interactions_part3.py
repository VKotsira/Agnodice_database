...
#
# fields = pd.read_excel('C:/Users/.../Agnodice_fields_study_31761494.xlsx', keep_default_na=False)
# ecocyc_gff = pd.read_excel('C:/Users/.../Ecocyc_ecoli_MG1655_K12_sorted.xlsx')
#
# # sort by coordinates
...
# fields.to_excel('C:/Users/.../Agnodice_31761494_without_srna_seq.xlsx', index=False)
#
...
#
# bed_file.to_csv('C:/Users/.../bed_31761494.txt', sep="\t", index=False, header= False)
...
fields = pd.read_excel('C:/Users/.../Agnodice_31761494_without_srna_seq.xlsx', keep_default_na=False)
fields_dict = fields.to_dict('records')

#bedtools getfasta output: proper format
seq_srna = pd.read_csv('C:/Users/.../srna_seq_31761494.txt', header=None)
...
fields.to_excel('C:/Users/.../Agnodice_31761494_final.xlsx', index=False)
